...
function navbar() {
  return (
<div className='w-5/6 h-8 bg-slate-800 rounded-3xl p-7 flex justify-between items-center  border-gray-700'>
      ...
      <div className='hidden relative bottom-3 md:flex gap-x-4 place-content-center text-l  '>
       <div className='flex items-center justify-center hover:bg-slate-500 hover:text-white rounded-3xl p-3.5 transition duration-300 ease-in-out'>
      Home
      </div>
       <span className='flex items-center justify-center hover:bg-slate-500 hover:text-white rounded-2xl p-3.5 transition duration-300 ease-in-out'>
      Careers
      </span>
       <span className='flex items-center justify-center  hover:bg-slate-500 hover:text-white rounded-2xl p-3.5 transition duration-300 ease-in-out' >
      About
      ...
      <a href="./Components/Login.jsx" className='w-24 h-10 bg-[#CAFF33] text-black font-bold   hidden md:flex items-center justify-center rounded-3xl p-5  relative  bottom-5 '>
       <button>Login</button>
      </a>    
    </div>
  )
